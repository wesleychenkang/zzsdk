 ...
 */
public class Login extends JsonParseInterface implements Serializable {
	...
	public String toString() {
		return "Login [account=" + account + ", md5pwd=" + md5pwd
		+ ", atype=" + atype + ", dtype" + dtype + ", lastIP"
		+ lastIP + ", app_secret" + app_secret + ", sign" + sign + "]";
	}
